...
- **README**: Updated installation example to reference the current package version (`^2.3.1`)

### Added

- **Publishing workflow**: Added `PUBLISHING_CHECKLIST.md` and Cursor rule `.cursor/rules/publishing.mdc` for pre-release verification
...
- **Dependency Updates**: Updated package dependencies to latest compatible versions
    - Updated http from 1.5.0 to 1.6.0
    - Updated lints from 6.0.0 to 6.1.0
